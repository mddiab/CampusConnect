        ...
        <style>
            ...
            * {
            ...
            .assistant-launcher {
                ...
                border-radius: 22px;
                border: 1px solid rgba(95, 67, 167, 0.18);
                background: linear-gradient(135deg, var(--primary-strong), var(--primary));
                color: #ffffff;
                box-shadow: 0 18px 38px rgba(63, 40, 111, 0.2);
                width: auto;
            }

            .assistant-launcher:hover {
                box-shadow: 0 22px 44px rgba(63, 40, 111, 0.24);
            }
            ...
            .assistant-panel {
                ...
                border-radius: 24px;
                border: 1px solid rgba(95, 67, 167, 0.16);
                background: linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(246, 240, 252, 0.98));
                box-shadow: 0 30px 80px rgba(63, 40, 111, 0.18);
            ...
            .assistant-header {
                ...
                border-bottom: 1px solid rgba(95, 67, 167, 0.1);
            }
            ...
            .assistant-avatar {
                ...
                background: linear-gradient(135deg, var(--primary-strong), var(--primary));
                color: #ffffff;
                box-shadow: 0 14px 30px rgba(95, 67, 167, 0.18);
            }
            ...
            .assistant-presence::before {
                content: "";
                width: 8px;
                height: 8px;
                border-radius: 50%;
                background: #4cb782;
                box-shadow: 0 0 0 4px rgba(76, 183, 130, 0.12);
            }
            ...
            .assistant-message {
                ...
                padding: 12px 14px;
                border-radius: 18px;
                box-shadow: 0 10px 22px rgba(63, 40, 111, 0.06);
            }
            ...
            .assistant-action-link:hover {
                border-color: rgba(95, 67, 167, 0.22);
                color: #4d358b;
                box-shadow: 0 10px 24px rgba(63, 40, 111, 0.08);
            }
            ...
            .assistant-form input:focus {
                outline: none;
                border-color: rgba(95, 67, 167, 0.28);
                box-shadow:
                    0 0 0 4px rgba(95, 67, 167, 0.08),
            ...
            .assistant-submit {
                ...
                background: linear-gradient(135deg, var(--primary-strong), var(--primary));
                color: #ffffff;
                box-shadow: 0 14px 28px rgba(95, 67, 167, 0.2);
                width: auto;
            }
